...
const ApplyDoctor = () => {
  ...
  const handleFinish = async (values) => {
    try{
      ...
      const res = await axios.post("/api/v1/user/apply-doctor", {...values, userId:user._id,timings}, //form se data backend ke pas chla jayega
        {
          headers: {
  ...
  return (
    <Layout>
      <h1 className="text-center">Become A Doctor</h1>
